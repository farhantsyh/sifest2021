                                                        ...
                                                        <div class="accordion" id="accordionExample">
                                                          ...
                                                          <div class="accordion-item">
                                                            <h5 class="accordion-header" id="headingFive">
                                                                <a href="#" class="btn btn-outline-primary btn-sm" data-bs-toggle="collapse" data-bs-target="#playerFive" aria-expanded="false" aria-controls="playerFive">Player 5 (Opsional)</a>
                                                            </h5>
